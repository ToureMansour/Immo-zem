...
@section('title', 'Nouvelle Location de Zem')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Nouvelle Location de Zem</h2>
                <p class="text-gray-600 mt-1">Démarrer une nouvelle location de moto pour un conducteur</p>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] overflow-hidden">
        <form action="{{ route('locations_motos.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
                            ...
                            <select id="moto_id" name="moto_id" required
                                ...
                                @foreach($motos as $moto)
                                    <option value="{{ $moto->id }}" 
                                            ...
                                            data-kilometrage="{{ $moto->kilometrage }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="duree_jours" name="duree_jours" required
                               value="{{ old('duree_jours', 1) }}" min="1" max="365"
                               class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">
                        @error('duree_jours')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="caution" name="caution" required
                               value="{{ old('caution', 10000) }}" min="0" step="100"
                               class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">
                        @error('caution')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" id="acompte" name="acompte" required
                               value="{{ old('acompte', 0) }}" min="0" step="100"
                               class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">
                        @error('acompte')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="w-full px-4 py-3 rounded-lg bg-gray-100 border border-gray-300 text-gray-700 font-bold">
                            <span id="montant-total">0</span> F
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="w-full px-4 py-3 rounded-lg bg-yellow-50 border border-yellow-200 text-yellow-700 font-bold">
                        <span id="reste-a-payer">0</span> F
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="kilometrage_depart" name="kilometrage_depart" required
                               value="{{ old('kilometrage_depart') }}" min="0"
                               class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">
                    ...
                    <!-- Observations -->
                    <div>
                        <label for="observations_depart" class="block text-sm font-semibold text-gray-700 mb-2">Observations</label>
                        <textarea id="observations_depart" name="observations_depart" rows="3"
                                  ...
                                  placeholder="État général, rayures, etc.">{{ old('observations_depart') }}</textarea>
