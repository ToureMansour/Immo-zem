        ...
        <form action="{{ route('motos.update', $moto) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" id="immatriculation" name="immatriculation" value="{{ old('immatriculation', $moto->immatriculation) }}" required placeholder="Ex: ABJ-1234-CI"
                ...
                <div>
                    ...
                    <input type="text" id="marque" name="marque" value="{{ old('marque', $moto->marque) }}" required placeholder="Ex: Honda, Yamaha, Kawasaki"
                ...
                <div>
                    ...
                    <input type="text" id="modele" name="modele" value="{{ old('modele', $moto->modele) }}" required placeholder="Ex: CG 125, MT-07"
                           class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">
                    @error('modele')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        <select id="type_moto" name="type_moto" required
                            ...
                            <option value="taxi" {{ old('type_moto', $moto->type_moto) == 'taxi' ? 'selected' : '' }}>Taxi</option>
                            <option value="personnel" {{ old('type_moto', $moto->type_moto) == 'personnel' ? 'selected' : '' }}>Personnel</option>
                            <option value="livraison" {{ old('type_moto', $moto->type_moto) == 'livraison' ? 'selected' : '' }}>Livraison</option>
                        </select>
                ...
                <div>
                    ...
                    <input type="number" id="annee" name="annee" value="{{ old('annee', $moto->annee) }}" required min="1900" max="{{ date('Y') }}" placeholder="Ex: 2023"
                           class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">
                    @error('annee')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" id="couleur" name="couleur" value="{{ old('couleur', $moto->couleur) }}" required placeholder="Ex: Rouge, Noir, Bleu"
                           class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">
                    @error('couleur')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" id="prix_journalier" name="prix_journalier" value="{{ old('prix_journalier', $moto->prix_journalier) }}" required step="100" min="0" placeholder="Ex: 10000"
                           class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">
                ...
                <div>
                    ...
                    <input type="number" id="prix_avec_credit" name="prix_avec_credit" value="{{ old('prix_avec_credit', $moto->prix_avec_credit) }}" required step="100" min="0" placeholder="Ex: 15000"
                           class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">
                ...
                <div>
                    ...
                    <input type="number" id="prix_location_vente" name="prix_location_vente" value="{{ old('prix_location_vente', $moto->prix_location_vente) }}" required step="100" min="0" placeholder="Ex: 20000"
                           class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">
                ...
                <div>
                    ...
                    <div class="relative">
                        <select id="statut" name="statut" required
                            ...
                            <option value="loue" {{ old('statut', $moto->statut) == 'loue' ? 'selected' : '' }}>Louée</option>
                            <option value="reparation" {{ old('statut', $moto->statut) == 'reparation' ? 'selected' : '' }}>En réparation</option>
                            <option value="hors_service" {{ old('statut', $moto->statut) == 'hors_service' ? 'selected' : '' }}>Hors service</option>
                        </select>
                        <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-gray-500">
                            <i class="fa-solid fa-chevron-down text-xs"></i>
                        </div>
                ...
                <div>
                    ...
                    <input type="number" id="kilometrage" name="kilometrage" value="{{ old('kilometrage', $moto->kilometrage) }}" required min="0" placeholder="Ex: 25000"
                           class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">
                    @error('kilometrage')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="date" id="date_derniere_maintenance" name="date_derniere_maintenance" value="{{ old('date_derniere_maintenance', $moto->date_derniere_maintenance) }}"
                ...
                <div>
                    ...
                    <input type="text" id="carte_grise_numero" name="carte_grise_numero" value="{{ old('carte_grise_numero', $moto->carte_grise_numero) }}" required placeholder="Ex: CG-ABJ-123456"
                           class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all uppercase">
                ...
                <div>
                    ...
                    <input type="date" id="carte_grise_delivrance" name="carte_grise_delivrance" value="{{ old('carte_grise_delivrance', $moto->carte_grise_delivrance) }}" required
                           class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all text-gray-600">
            ...
            <div class="mb-6">
                ...
                <textarea id="description" name="description" rows="4" placeholder="Décrivez la moto, ses caractéristiques, son état..."
                          class="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#445f47] focus:ring-2 focus:ring-[#445f47]/20 outline-none transition-all">{{ old('description', $moto->description) }}</textarea>
                @error('description')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex items-center justify-end gap-4 mt-8 pt-6 border-t border-gray-100">
                <a href="{{ route('motos.show', $moto) }}" class="px-6 py-2.5 rounded-lg text-gray-600 hover:bg-gray-100 font-medium transition-colors">
                    Annuler
                </a>
